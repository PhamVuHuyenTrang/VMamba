...
from models.custom_functions import prepare_forward, ensure_comm
...
def _fmoe_general_global_forward(
   ...
   # import pdb;pdb.set_trace()
    ...
    def gather_func(tensor):
        ...
        assert pos.max() < 6272, f"Index out of range: pos.max()={pos.max()} >= 6272"
        assert pos.min() >= 0, f"Negative index found: pos.min()={pos.min()}"
